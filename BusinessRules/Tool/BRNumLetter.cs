...
namespace BusinessRules.Tool
{
    public class BRNumLetter
    {
        ...
        public String Convertir(String numero, bool mayusculas, string mone)
        {
            ...
            if (mc.Count > 0)
            {
                ...
                parte_decimal = String.Format("CON {0}/100 {1}", Num[1].Substring(0, 2), ((mone == "S/.") ? "NUEVOS SOLES." : "DOLARES AMERICANOS"));
