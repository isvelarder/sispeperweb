...
{
    public class BRSVTD_COTI : IDisposable
    {
        private DASales oDa;
        ...
        /// <returns></returns>
        public List<BESVTD_COTI> Get_SVPR_COTI_DETA_LIST(BESVTD_COTI oBe)
        {
            try
            {
                using (IDataReader oDr = oDa.Get_SVPR_COTI_DETA_LIST(oBe))
                {
