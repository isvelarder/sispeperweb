...
{
    public class BRSVTD_OVEN : IDisposable
    {
        private DASales oDa;
        ...
        /// <returns></returns>
        public List<BESVTD_OVEN> Get_SVPR_OVEN_DETA_LIST(BESVTD_OVEN oBe)
        {
            try
            {
                using (IDataReader oDr = oDa.Get_SVPR_OVEN_DETA_LIST(oBe))
                {
